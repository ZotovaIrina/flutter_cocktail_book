          ...
          child: Flex(
            ...
            children: [
              ...
              NavigationButton(
                  ...
                  onButtonPress: () => context.go('/allIngredients'),
                  isActive: isActiveRouter(route, '/allIngredients')),
              NavigationButton(
                  buttonIcon: Icons.add_box,
                  buttonText: 'Create Ingredient',
                  onButtonPress: () => context.go('/createIngredient'),
                  isActive: isActiveRouter(route, '/createIngredient')),
            ],
          ),
        ),
      ),
